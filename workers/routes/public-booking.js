...
<label class="span">How did you hear about ${artist}? <span class="required">*</span><select name="discoverySource" required><option value="">Choose one</option><option value="instagram">Instagram</option><option value="chatgpt">ChatGPT</option><option value="other_ai">Other AI / LLM</option><option value="friend_referral">Friend / recommendation</option><option value="google">Google</option><option value="other">Other</option></select><small>For example: Instagram, ChatGPT, other AI/LLMs, recommendations from friends, Google, etc.</small></label>
