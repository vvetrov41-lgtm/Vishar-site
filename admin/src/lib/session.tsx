...
import { createWhatsappApi, type WhatsappApi } from './whatsapp-api';
...
export type CrmApi = Api & AppointmentApi & AvailabilityApi & CalendarConnectionsApi & OAuthConsentApi & ManualIntakeApi & PaymentApi & WhatsappApi;
