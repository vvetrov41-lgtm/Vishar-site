...
export const API_OPERATIONS = {
  ...
  'hide that attention item': { kind: 'write', ru: 'убрать эту карточку из внимания' },
  ...
  'load hidden attention items': { kind: 'read', ru: 'загрузить скрытые карточки внимания' },
...
export const API_MESSAGES = {
  ...
  'Could not load your account.': 'Не удалось загрузить ваш аккаунт. Данные не загружены — обновите страницу.',
  'Could not load attention acknowledgements.': 'Не удалось загрузить скрытые карточки внимания. Данные не загружены — обновите страницу.',
  'Could not save your name.': 'Не удалось сохранить имя. Изменения не сохранены — попробуйте ещё раз.',
  'Could not delete your account.': 'Не удалось удалить аккаунт. Ничего не удалено — попробуйте ещё раз.',
  'Could not change signup availability.': 'Не удалось изменить доступность регистрации. Изменения не сохранены — попробуйте ещё раз.',
  ...
  'Could not finish setting up your CRM.': 'Не удалось завершить настройку CRM. Ничего не создано — попробуйте ещё раз.',
