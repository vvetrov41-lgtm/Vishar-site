...
export const ACTIVITY_EVENT_TYPES = [
  ...
  'integration.google_contacts_disabled',
  'integration.google_contacts_enabled',
  'integration.queued',
  'membership.updated',
  'note.created',
  'outbox.failed',
  ...
  'project.deposit_updated',
  'project.estimate_updated',
  'project.reviewed',
...
const LABELS: Record<Language, Record<OperationalLabelGroup, Record<string, string>>> = {
  en: {
    event: {
      ...
      'integration.google_contacts_disabled': 'Google Contacts sync disabled',
      'integration.google_contacts_enabled': 'Google Contacts sync enabled',
      ...
      'project.deposit_updated': 'Project deposit updated',
      'project.estimate_updated': 'Project estimate updated',
    ...
    integrationKind: {
      ...
      google_contact_create: 'Save Google contact',
    ...
    integrationError: {
      ...
      google_contact_job_invalid: 'Google contact job is invalid',
      google_contacts_connector_error: 'Google Contacts connector failed',
      google_contacts_create_result_unknown: 'Google Contacts create result is uncertain and will be checked again',
      google_contacts_metadata_update_failed: 'Google Contacts connection metadata could not be updated',
      google_contacts_not_enabled: 'Google Contacts sync is not enabled',
      google_contacts_permission_denied: 'Google Contacts permission was denied',
      google_contacts_provider_rejected: 'Google Contacts rejected the request',
      google_contacts_provider_unavailable: 'Google Contacts is temporarily unavailable',
      google_contacts_scope_missing: 'Google Contacts permission is missing; reconnect Google',
  ...
  ru: {
    event: {
      ...
      'integration.google_contacts_disabled': 'Синхронизация Google Contacts отключена',
      'integration.google_contacts_enabled': 'Синхронизация Google Contacts включена',
      ...
      'project.deposit_updated': 'Депозит проекта обновлён',
      'project.estimate_updated': 'Расчёт проекта обновлён',
    ...
    integrationKind: {
      ...
      google_contact_create: 'Сохранение контакта Google',
    ...
    integrationError: {
      ...
      google_contact_job_invalid: 'Некорректная задача Google Contacts',
      google_contacts_connector_error: 'Ошибка Google Contacts connector',
      google_contacts_create_result_unknown: 'Результат создания контакта неизвестен, CRM проверит его повторно',
      google_contacts_metadata_update_failed: 'Не удалось обновить метаданные Google Contacts',
      google_contacts_not_enabled: 'Синхронизация Google Contacts не включена',
      google_contacts_permission_denied: 'Нет разрешения Google Contacts',
      google_contacts_provider_rejected: 'Google Contacts отклонил запрос',
      google_contacts_provider_unavailable: 'Google Contacts временно недоступен',
      google_contacts_scope_missing: 'Нет разрешения Google Contacts, переподключи Google',
