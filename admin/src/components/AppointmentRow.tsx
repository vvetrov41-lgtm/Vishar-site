...
const COPY: Record<Language, Record<string, string>> = {
  en: {
    project: 'Project', enquiry: 'Enquiry', client: 'Client', noProject: 'No project',
    reschedule: 'Reschedule', newStart: 'New start', newEnd: 'New end', saveReschedule: 'Save new time',
    goBack: 'Go back', saving: 'Saving…', confirm: 'Confirm', markCompleted: 'Mark completed',
    markNoShow: 'Mark no-show', cancel: 'Cancel', calendar: 'Calendar',
  },
  ru: {
    project: 'Проект', enquiry: 'Заявка', client: 'Клиент', noProject: 'Без проекта',
    reschedule: 'Перенести', newStart: 'Новое начало', newEnd: 'Новое окончание', saveReschedule: 'Сохранить новое время',
    goBack: 'Назад', saving: 'Сохраняем…', confirm: 'Подтвердить', markCompleted: 'Завершить',
    markNoShow: 'Не пришёл', cancel: 'Отменить', calendar: 'Календарь',
  },
};
