...
/**
 * The single user-facing Telegram integration.
 *
 * New enquiry notifications are routed through the artist-bound destination.
 * It is rendered on Notifications. The old /integrations/telegram deep link is
 * kept only as a compatibility route and renders this same surface.
 */
