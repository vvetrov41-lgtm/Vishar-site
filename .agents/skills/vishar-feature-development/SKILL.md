...
2. Adding a CRM screen/button/RPC/provider management action must update the parity inventory when it introduces or changes a meaningful operator action.
