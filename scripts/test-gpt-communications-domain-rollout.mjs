...
assert.deepEqual([coreIds.length, operationsIds.length, communicationsIds.length], [28, 19, 10]);
assert.equal(new Set([...coreIds, ...operationsIds, ...communicationsIds]).size, 57);
