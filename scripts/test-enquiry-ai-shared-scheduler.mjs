...
await assert.rejects(
  runSharedEnquiryAiDrain({}),
  (error) => error?.code === 'tattooai_service_binding_unavailable',
);
...
console.log('Enquiry AI shared scheduler tests passed: production-only capability-bound service fetch shares the existing scheduler and cannot suppress sibling work.');
