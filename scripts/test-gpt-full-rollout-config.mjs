...
assert.match(monzoWorkflow, /0063\\s\*\\\|\\s\*0063/);
...
assert.match(monzoWorkflow, /0064\\s\*\\\|\\s\*0064/);
assert.match(monzoWorkflow, /0065\\s\*\\\|\\s\*0065/);
assert.match(monzoWorkflow, /0066\\s\*\\\|\\s\*0066/);
