# GEO Project Profile — Vladimir Vishar

## Purpose

This profile adapts the generic GEO Topic Agent to Vladimir Vishar's personal
tattoo-artist website. It is project context, not permission to rewrite the
website or publish new pages.
...
- Custom Black & Grey Realism tattoos.
- Custom Colour Realism tattoos.
- Cover-up tattoos, subject to assessment.
- Custom tattoo design and free consultation.
- Realism portraits.
- Wildlife, floral, mythology, dark realism, and horror compositions.
- Medium and large multi-session realism projects.

Do not expand the service list merely to target keywords. Portfolio evidence
and existing business facts must support every claimed specialty.
...
page per query. Expand it only from Search Console, verified SERP evidence, or
explicit user approval.

## Measurement boundaries

Track these as separate outcomes:

- ordinary organic position;
- AI-answer presence;
- citation of a `vishartattoo.com` URL;
- brand mention;
- Vladimir presented as a relevant solution or recommendation;
- qualified enquiry intent.

Do not report one outcome as proof of another. `llms.txt`, crawler access, or a
successful fetch does not guarantee an LLM citation or recommendation.
...
- Treat mobile and desktop search results as separate evidence dimensions.

## Competitor policy

No competitor list is hard-coded yet. Select competitors from current local
SERP and AI-citation evidence for the approved query cluster. Distinguish an
individual tattoo artist from a multi-artist studio, directory, magazine, or
marketplace; do not compare unlike entities without labelling the difference.
...
- Paid SERP or AI-provider collection always requires a separately reviewed
  query inventory, request count, and budget approval.
