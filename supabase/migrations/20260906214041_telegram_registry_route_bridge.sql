-- 20260906214041_telegram_registry_route_bridge.sql
--
-- History-sync migration for the incident remediation already applied to
-- production under this exact Supabase migration version. Keeping the original
-- version in source control reconciles local/remote migration history without
-- rewriting production history or applying a duplicate 0142 migration.
