...
insert into expected_function_acl values
  ...
  ('public.create_hosted_enquiry_intake(uuid,uuid,jsonb,jsonb,jsonb)', false, false, true),
  ...
  ('public.resolve_hosted_booking_source(uuid)', false, false, true),
  ...
  ('public.list_booking_sources(uuid)', false, true, false),
  ('public.create_booking_source(uuid,text,text,text,text,boolean)', false, true, false),
