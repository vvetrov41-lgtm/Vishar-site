...
insert into expected_function_acl values
  ...
  ('public.record_whatsapp_inbound_message(text,text,text,text,text,timestamptz,text)', false, false, true),
  ('public.record_whatsapp_echo_message(text,text,text,text,text,timestamptz)', false, false, true),
  ('public.record_whatsapp_status_update(text,text,text,timestamptz,text)', false, false, true),
